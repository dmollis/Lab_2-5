...
--
-- Хост: localhost
-- Время создания: Мар 25 2025 г., 09:52
...
(1, 'Базисґрунт 5кг', 3, '92.85', '9.9', '102.00', '20.6', '112.00', 6),
...
(5, 'Ґрунт Тифенґрунт 5кг', 3, '169.00', '9.5', '185.00', '10.7', '187.00', 165),
...
(1, 'Альфа-Профіль', NULL),
(2, 'Амадео', NULL),
(3, 'КНАУФ', '099 04 10 159'),
(4, 'Сен-Гобен', '050 106 34 39'),
(5, 'Полісан', NULL),
(6, 'Робфіл', NULL);
...
(1, 2, 2, 'incoming', '2025-03-25 09:48:35');
